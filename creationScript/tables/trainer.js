...
const trainer = (nameList, surnameList, addressList, howMany) => {

  let rows = "";
  let keys = "";
  const rowArray = [];
  const insert = `INSERT INTO ${TABLENAME.TRAINER} ( trainerID_PK, trainerFname, trainerLname, address, stable_FK) VALUES `
  rows += insert;
  ...
  fs.writeFileSync("../insert/trainer", keys);
